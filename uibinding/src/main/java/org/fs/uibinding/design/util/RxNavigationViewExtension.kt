...
fun NavigationView.checkedPropert(predicate: (MenuItem) -> Boolean = { _ -> true }): ControlPorperty<Int> = ControlPorperty(checkedChanges(predicate).map { it.itemId }, checked())